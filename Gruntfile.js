        ...
        less: {
            development: {
                ...
                files: {
                    ...
                    ".tmp/styles/back-login.css": "<%= web.app %>/assets/less/back-login.less",
                    ".tmp/styles/back-register.css": "<%= web.app %>/assets/less/back-register.less",
                    ".tmp/styles/back-faq.css": "<%= web.app %>/assets/less/back-faq.less",
                    ".tmp/styles/back-responder.css": "<%= web.app %>/assets/less/back-responder.less",
                    ".tmp/styles/index.css": "<%= web.app %>/assets/less/index.less",
                    ".tmp/styles/advertise.css": "<%= web.app %>/assets/less/advertise.less"
                }
            }
        },
